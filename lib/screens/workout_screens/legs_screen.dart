...
import 'workout_classes/LegsWorkout.dart';
...
class LegsScreen extends StatefulWidget {
  static const String id = 'legs_screen';
  final Workout workout = LegsWorkout();
          ...
          child: Container(
            ...
            child: Column(
              ...
              children: <Widget>[
                ...
                Exercise(
                  exerciseName: "Squats",
                  duration: "10 sets 30 seconds",
                ),
                SizedBox(height: 12),
                Exercise(
                  exerciseName: "Rear Elevated Split Squat",
