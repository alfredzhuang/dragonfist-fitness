...
import 'workout_classes/ChestWorkout.dart';
import 'package:dragonfistfitness/components/arguments.dart';

class ChestScreen extends StatefulWidget {
  static const String id = 'chest_screen';
  final Workout workout = ChestWorkout();
        ...
        child: SafeArea(
          child: Container(
            ...
            child: Column(
              ...
              children: <Widget>[
                Text('CHEST', style: kHeadingTextStyle),
                SizedBox(height: 12),
                Container(
                  width: double.infinity,
                  height: 40,
                ...
                Exercise(
                  ...
                  duration: "40 sets 30 seconds",
                ),
                SizedBox(height: 12),
                Exercise(
                  exerciseName: "Incline Pushups",
                  duration: "20 sets 30 seconds",
                ),
                SizedBox(height: 12),
              ],
            ),
